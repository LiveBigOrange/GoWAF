...
type InterceptEvent struct {
	ID                int64              `json:"id"`
	Time              xutil.LocalTime `json:"timestamp"`
...
type HourlyStats struct {
	TimeHour        xutil.LocalTime `json:"time_hour"`
...
type MinuteStats struct {
	TimeMinute      xutil.LocalTime `json:"time_minute"`
	TotalRequests   int64              `json:"total_requests"`
	BlockedRequests int64              `json:"blocked_requests"`
	AvgQPS          float64            `json:"avg_qps"`
	AvgLatencyMs    float64            `json:"avg_latency_ms"`
...
type DailyStats struct {
	Date            xutil.LocalTime `json:"date"`
	TotalRequests   int64              `json:"total_requests"`
	BlockedRequests int64              `json:"blocked_requests"`
	AvgQPS          float64            `json:"avg_qps"`
	AvgLatencyMs    float64            `json:"avg_latency_ms"`
...
type TopStatItem struct {
	...
	LastSeen      xutil.LocalTime `json:"last_seen"`
